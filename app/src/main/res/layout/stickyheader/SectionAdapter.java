...
public class SectionAdapter extends StickyAdapter<RecyclerView.ViewHolder, RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == Section.HEADER || viewType == Section.CUSTOM_HEADER) {
            return new HeaderViewholder(inflater.inflate(com.shuhart.stickyheader.R.layout.recycler_view_header_item, parent, false));
        }
        return new ItemViewHolder(inflater.inflate(com.shuhart.stickyheader.R.layout.recycler_view_item, parent, false));
    }
    ...
    public static class HeaderViewholder extends RecyclerView.ViewHolder {
        ...
        HeaderViewholder(View itemView) {
            super(itemView);
            textView = itemView.findViewById(com.shuhart.stickyheader.R.id.text_view);
        }
    }
